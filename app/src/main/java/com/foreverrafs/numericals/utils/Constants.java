...
/**
 * Created by Rafsanjani on 6/6/2019
 */
public class Constants {
    //Main Menus Constants
    public static final int MENU_NUMBER_CONVERSION = 1;
    public static final int MENU_SYSTEM_OF_EQUATIONS = 2;
    public static final int MENU_ODE = 3;
